...
Brush.prototype.gradientDraw=function(){canvasRect=canvas.getBoundingClientRect();var a=Util.hexToRgb(tool.brush.colour);a.r-=this.gradientTimer;a.g-=this.gradientTimer;a.b-=this.gradientTimer;0>=a.r&&(a.r=0);0>=a.g&&(a.g=0);0>=a.b&&(a.b=0);a=Util.rgbToHex(a);a={name:name,x:Input.mousePos.x-canvasRect.left,y:Input.mousePos.y-canvasRect.top,lastX:Input.lastPos.x-canvasRect.left,lastY:Input.lastPos.y-canvasRect.top,size:tool.brush.size,colour:a};tool.shapeTool.drawCircle(a.x,a.y,a.lastX,a.lastY,a.size,
a.colour);socket.emit("draw",a)};
Brush.prototype.rainbowDraw=function(){canvasRect=canvas.getBoundingClientRect();var a=Util.hexToRgb(tool.brush.colour);ColourPicker.huePosition=new Position(0,this.rainbowPointer);a=ColourPicker.getColourOnHueCanvas(ColourPicker.getHueContext(),ColourPicker.huePosition);a=Util.rgbToHex(a);a={name:name,x:Input.mousePos.x-canvasRect.left,y:Input.mousePos.y-canvasRect.top,lastX:Input.lastPos.x-canvasRect.left,lastY:Input.lastPos.y-canvasRect.top,size:this.size,colour:a};tool.shapeTool.drawCircle(a.x,
...
Brush.prototype.draw=function(){canvasRect=canvas.getBoundingClientRect();var a={name:name,x:Input.mousePos.x-canvasRect.left,y:Input.mousePos.y-canvasRect.top,lastX:Input.lastPos.x-canvasRect.left,lastY:Input.lastPos.y-canvasRect.top,size:tool.brush.size,colour:tool.brush.colour};tool.shapeTool.drawCircle(a.x,a.y,a.lastX,a.lastY,a.size,a.colour);socket.emit("draw",a)};
